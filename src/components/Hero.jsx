...
function Hero({ setOpenModal }) {
  return (
    <section className=" custom-padding  dark:bg-linear-to-b from-primary-1500 to-primary-1300 md:pt-12 lg:pt-24 lg:pb-10 2xl:max-w-6xl 2xl:mx-auto">
      <div className=" flex flex-col lg:flex-row py-14 md:py-0 items-start lg:items-center justify-between">
        <div className="">
          <h1 className=" text-primary-text-light dark:text-primary-text text-[1.6rem] md:text-[2.8rem] font-bold">
            AI-Powered Notes.
