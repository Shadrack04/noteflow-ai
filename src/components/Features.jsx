...
function Features() {
  return (
    <section className=" custom-padding dark:bg-primary-1500 py-20 ">
      <p className=" text-primary-text-light dark:text-primary-text text-[1.8rem] md:text-5xl font-bold text-center md:py-20">
        All The Tools You Need to <br className="hidden lg:flex" />
        <span className=" text-secondary-text-light dark:text-special-text">
          Supercharge
        </span>{" "}
        Your Note Taking
      </p>
      <div className=" flex flex-col gap-4 md:gap-8 ">
        <div className=" flex flex-col-reverse lg:flex-row items-center justify-center gap-20 my-8 md:my-2">
          ...
          <div>
            ...
            <p className=" text-secondary-text-light dark:text-secondary-text text-[0.9rem] md:text-lg leading-8 md:leading-10">
